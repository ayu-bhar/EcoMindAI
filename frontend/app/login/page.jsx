...
import { Leaf, ArrowLeft, ShieldCheck, Zap, Globe } from 'lucide-react';
      ...
      <div className="w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 bg-white/[0.02] border border-white/10 rounded-[2.5rem] overflow-hidden backdrop-blur-3xl shadow-2xl relative z-10">
          ...
          <div className="relative z-10">
            ...
            <div className="space-y-6 mt-12">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-sm">Encrypted Dashboard</h4>
                  <p className="text-zinc-500 text-xs">Your community data is protected with enterprise-grade security.</p>
                </div>
              </div>
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-white font-bold text-sm">Instant Sync</h4>
                  <p className="text-zinc-500 text-xs">Access real-time AI modeling across all your devices.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-col justify-center items-center p-8 md:p-16 bg-white/[0.01]">
          ...
          >
            ...
            <button
              onClick={googleLogin}
              className="w-full flex items-center justify-center gap-3 bg-white hover:bg-zinc-200 text-black font-black py-4 px-6 rounded-2xl transition-all active:scale-[0.98] shadow-xl shadow-green-500/5 group"
            >
              <img 
            ...
            <div className="relative my-10">
              ...
              <div className="relative flex justify-center text-[10px] uppercase tracking-[0.3em] font-bold text-zinc-600">
                <span className="bg-[#0b1211] px-4">Authorized Access Only</span>
              </div>
            </div>
            ...
            <p className="text-center text-[10px] text-zinc-600 leading-relaxed uppercase tracking-widest font-bold">
              ...
              <Link href="#" className="text-zinc-400 hover:text-green-500 transition-colors underline underline-offset-4">Terms of Governance</Link> and <Link href="#" className="text-zinc-400 hover:text-green-500 transition-colors underline underline-offset-4">Privacy Protocols</Link>.
            </p>
          </motion.div>
        </div>
      </div>
